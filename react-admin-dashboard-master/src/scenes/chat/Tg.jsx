...
export default function TelegramHome() {
    ...
    const [loginStatus, setLoginStatus] = useState(3)
                        ...
                        <div className="tgChat_userInfo">
                            ...
                            <div className={isOpenminSet}>
                                ...
                                <div className="prmSetseting">
                                    <button onClick={() => setIsOpenminSet('none')}><MdOutlineBlock size={'26px'} /><span>Block User</span></button>
                                    <button onClick={() => setIsOpenminSet('none')}><BsVolumeMute size={'30px'} /><span>Ovozsiz</span></button>
                                    <button onClick={() => setIsOpenminSet('none')}><AiOutlineDelete size={'30px'} /><span>O'chirish</span></button>
                                </div>
                            </div>
                        </div>
